...
% The value is computed from three random images of HYTA dataset.
    ...
    I1=imread('./dataset/samples/B1.jpg');
    I1_GT=double(imread('./dataset/samples/B1_GT.jpg'));
    [X1_response,Y1_response]=create_XY_response(I1, I1_GT);

    I2=imread('./dataset/samples/B3.jpg');
    I2_GT=double(imread('./dataset/samples/B3_GT.jpg'));
    [X2_response,Y2_response]=create_XY_response(I2, I2_GT);

    I3=imread('./dataset/samples/B14.jpg');
    I3_GT=double(imread('./dataset/samples/B14_GT.jpg'));
